...
namespace AspNetBalanceSheet.Data
{
    public class BalanceSheetContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BalanceTransaction>().HasData(
                new BalanceTransaction { ID = 1, Date = DateTime.Now, IsFlip = false, TransactionType = "CREDIT", Account = "Cash", Amount = 10000.00m },
                new BalanceTransaction { ID = 2, Date = DateTime.Now, IsFlip = false, TransactionType = "DEBIT", Account = "Expenses", Amount = 10000.00m }
            );
